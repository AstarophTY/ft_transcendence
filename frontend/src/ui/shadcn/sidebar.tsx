...
function Sidebar({
  ...
  return (
    <div
      ...
      data-side={side}
    >
      {/* This is what handles the gap and resizely of the sidebar */}
      <div
        className={cn(
      ...
      <div
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ...
            : "group-data-[state=collapsed]:w-(--sidebar-width-icon) [border-inline-end-width:1px]",
          className
        )}
        {...props}
      >
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      ...
      <span className="sr-only">{i18n.t("common.sidebar.toggle")}</span>
    </Button>
  )
}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      aria-label={i18n.t("common.sidebar.toggle")}
      tabIndex={-1}
      onClick={toggleSidebar}
      title={i18n.t("common.sidebar.toggle")}
      className={cn(
