  ...
  return (
    <div
      className="z-50 flex flex-col gap-3 p-3 border rounded-xl bg-background/60 backdrop-blur-md supports-[backdrop-filter]:bg-background/40 text-card-foreground shadow-md absolute left-10 top-1/2 -translate-y-1/2
                 ...
                 /* Mobile Landscape Override: vertical left bar, glued to edge at top-left, h-auto to clear bottom joystick */
                 max-lg:landscape:fixed max-lg:landscape:left-0 max-lg:landscape:top-0 max-lg:landscape:bottom-auto max-lg:landscape:translate-y-0 max-lg:landscape:h-auto max-lg:landscape:w-auto max-lg:landscape:flex-col max-lg:landscape:justify-start max-lg:landscape:gap-4 max-lg:landscape:p-2 max-lg:landscape:pt-16 max-lg:landscape:border-r max-lg:landscape:border-b max-lg:landscape:border-t-0 max-lg:landscape:border-l-0 max-lg:landscape:rounded-none max-lg:landscape:rounded-br-xl max-lg:landscape:shadow-none max-lg:landscape:bg-background/60 max-lg:landscape:backdrop-blur-md max-lg:landscape:supports-[backdrop-filter]:bg-background/40"
    >
